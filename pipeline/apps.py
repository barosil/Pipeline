"""
pipeline appComponent module.

This is the module of pipeline containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/pipeline.MyApp/String/readonly/
